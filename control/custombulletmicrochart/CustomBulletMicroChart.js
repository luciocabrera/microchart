          ...
          for (var i = 0; i < oChartData.thresholdsPct.length; i++) {
            if (aData[i]._isValueSet) {
              if (oControl.getActual().getValue() < 0) {
                ...
                //     parseFloat(oChartData.thresholdsPct[i].valuePct).toFixed(
                //       2
                //     ) + '%'
                //   )
                // );
                ...
                // oRm.writeAttribute(
                //   'id',
                //   oControl.getId() + '-bcxx-target-bar-value'
                // );
                // oRm.write('></div>');
                ...
                // oRm.addStyle(
                //   'width',
                //   jQuery.sap.encodeHTML(oChartData.thresholdsPct[i] + '%')
                // );
                // oRm.writeStyles();
                // oRm.writeAttribute('id', oControl.getId() + '-bcx-bar-value');
                // oRm.write('></div>');
